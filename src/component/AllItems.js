    ...
    return (
        <>
            ...
            <div className='elements'>
                ...
                <div className='elements'>
                    <img className="images" src='https://e7.pngegg.com/pngimages/74/72/png-clipart-grocery-store-kabul-farms-supermarket-food-online-grocer-grocery-food-food-supermarket-thumbnail.png' alt='grocerey' />
                    <button className='products-button' onClick={() => filterItem("grocery")}><b>Grocery</b></button>
                </div>
                <div className='elements'>
                    <img className="images" src='https://png.pngitem.com/pimgs/s/522-5229966_sweden-interior-design-hd-png-download.png' alt='Home' />
                    <button className='products-button' onClick={() => filterItem("home")}><b>Home</b></button>
                </div>
                <div className='elements'>
                      ...
                      <button className='products-button' onClick={() => filterItem("electronics")}><b>Electronics</b></button>
                </div>
                <div className='elements'>
                    ...
                    <button className='products-button' onClick={() => filterItem("fashion")}><b>Fashion</b></button>
                </div>
                <div className='elements'>
                   ...
                   <button className='products-button' onClick={() => filterItem("books")}><b>Books</b></button>
                </div>
            </div>
                    ...
                    items.map((curElem) => {
                        ...
                        return (
                            <div className='main-card--cointainer' key={id}>
                                <AiOutlineHeart className="heartt"/>
                                <div className="card">
